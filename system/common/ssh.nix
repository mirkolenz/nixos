{ ... }:
{
  ...
  programs.ssh.knownHosts = {
    ...
    "macpro.lenz.casa".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIP5n2KpAU3E8iHy56vNURjh7E3l0EjkZ6BX450Z44hiH";
    "raspi.lenz.casa".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGR8BCsN02425GzSv1PQNhUGx0rm8D4aKSZh8ut5OJ6/";
  };
}
