...
let
  ...
  allVhosts =
    let
      enabledContainers = lib.filterAttrs (_: c: c.enable) config.virtualisation.quadlet.containers;
      containerVhosts = lib.mapAttrsToList (_: c: c.virtualHost) enabledContainers;
